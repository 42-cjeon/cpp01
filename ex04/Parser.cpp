...
/*   Updated: 2022/03/13 17:00:13 by cjeon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const std::string &Parser::filename(void) const {
  return filename_;
}

const std::string &Parser::s1(void) const {
  return s1_;
}

const std::string &Parser::s2(void) const {
  return s2_;
}
}
